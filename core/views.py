...
def search(request):
    ...
    if request.method == 'POST':
        search_query = request.POST['username']
    ...
    return render(request, 'search_results.html', {'user_profile': user_profile, 'username_profile_list': username_profile_list, 'search_query': search_query})
